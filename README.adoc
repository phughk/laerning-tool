...
There is an XML Schema Definition declared in file://laerning-module.xsd[laerning-module.xsd].
You can link it at the top of your XML files (like the ones in file://data/[data/]) to have it checked for correctness in your editor.
